export default function AboutBlock12() {
  return (
    <div className="flex flex-col lg:flex-row-reverse gap-3 lg:gap-28 lg:items-end px-5 lg:mx-28 lg:mb-[203px] font-inter font-normal relative z-20">
      ...
      <div className="flex flex-col gap-2 lg:gap-5">
        <h2 className="text-3xl lg:text-4xl text-[#171D3D]">
          Алексей Цыплаков — талантливый игрок, начавший карьеру в молодёжных
        ...
        <p className="text-base leading-[19.3px] text-[#5B5B5B]">
          ...
          сезона в КХЛ, где он набрал 47 очков (31 гол и 16 передач) в 65 матчах
