export function HomeWelcomeMob() {
  return (
    <div className="block lg:hidden max-w-5xl mx-auto justify-center items-center flex flex-col bg-[#171D3D] text-white py-5 px-2">
