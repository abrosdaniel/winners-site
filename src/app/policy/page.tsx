  ...
  return (
    <>
      ...
      <Wrapper size="small">
        ...
        <p className="font-inter text-base lg:text-lg leading-[21.8px] font-medium text-[#171D3D] px-2">
          ...
          предпринимаемые ИП «Черных Александр Юрьевич» (далее — Оператор).
          <br />
          ...
          Оператор может получить о посетителях веб-сайта https://wnrs.ru.
          <br />
          <br />
          ...
          в сети интернет по сетевому адресу https://wnrs.ru.
          <br />
          ...
          <br />
          2.10. Пользователь — любой посетитель веб-сайта https://wnrs.ru.
          <br />
          ...
          <br />
          Цель обработки: рассмотрение кандидатуры для дальнейшего
          сотрудничества.
          <br />
          Персональные данные: фамилия, имя, отчество, электронный адрес, номера
          телефонов, год, месяц, дата и место рождения, фотографии,
          свидетельство о гражданстве, реквизиты документа, удостоверяющего
          личность, адрес фактического места проживания и регистрации по месту
          жительстваи/или по месту пребывания, сведения об образовании,
          профессии, специальности и квалификации,реквизиты документов
          об образовании, сведения о семейном положении и составе семьи,
          сведения о доходах, сведения о занимаемых ранее должностях и стаже
          работы, воинскойобязанности, воинском учете.
          <br />
          ...
          agent@wnrs.ruс пометкой «Актуализация персональных данных».
          <br />
          ...
          электронной почты на электронный адрес Оператора agent@wnrs.ru
          ...
          к Оператору с помощью электронной почты agent@wnrs.ru.
          <br />
